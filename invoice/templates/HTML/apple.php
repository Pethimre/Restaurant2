<?php
/*
 * APPLE HTML INVOICE THEME
 * Visit https://code-boxx.com/invoicr-php-invoice-generator for more
 */

// HTML HEADER & STYLES
"</style></head><body><div id='invoice'>";
$this->data = "<!DOCTYPE html><html><head><title>".$_SESSION["username"]."' invoice"."</title><link rel='shortcut icon' href='../../images/favicon.ico' type='image/x-icon'/><style>".
"html,body{background-color: whitesmoke; font-family:sans-serif}#invoice{max-width:800px;margin:0 auto}#billship,#company,#items{width:100%;border-collapse:collapse}#company td,#billship td,#items td,#items th{padding:15px}#company,#billship{margin-bottom:30px}#company img{max-width:180px;height:auto}#bigi{font-size:28px;color:#5c9233}#billship{background:#b92d2d;color:#fff}#billship td{width:33%}#items th{text-align:left;border-top:2px solid #5c9233;border-bottom:2px solid #5c9233}#items td{border-bottom:1px solid #5c9233}.idesc{color:#ca3f3f}.ttl{font-weight:700}.right{text-align:right}#notes{margin-top:30px;font-size:.95em}".
"</style></head><body><div id='invoice'>";
...
// BILL TO
$this->data .= "<table id='billship' style='background-color: #8bc34a!important;'><tr><td><strong>BILL TO</strong><br>";
...
// ITEMS
$this->data .= "<table id='items'><tr><th>Item</th><th>Quantity</th><th>Unit Price</th><th>Subtotal</th></tr>";
